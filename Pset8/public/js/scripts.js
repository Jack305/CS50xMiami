...
$(function() {
    ...
    var options = {
        center: {lat: 25.778153, lng: -80.136337}, // Miami Beach, South Beach
...
function addMarker(place)
{
    ...
    // set the coordinates for the mrker
    ...
    // listens for the clicks on the markers
    marker.addListener('click', function() {
        ...
        $.getJSON("articles.php", "geo=" + place.place_name)
            ...
            $.each(article, function(key, value){
                c += "<li><a href='" + value.link + "'>" + value.title + "</a></li>";
            });
